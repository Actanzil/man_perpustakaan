<?php
  ...
  $query = mysqli_query($conn, "INSERT INTO tb_buku (kode_buku, judul_buku, penulis_buku, penerbit_buku, tahun_terbit, stock) VALUES ('$kd_buku', '$judul', '$penulis', '$penerbit', '$tahun', '$stock')");
