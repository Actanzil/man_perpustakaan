<?php
    ...
    if (isset($_POST['update'])) {
        ...
        $lihatdataskrg = mysqli_query($conn, "SELECT * FROM tb_buku_keluar WHERE id_keluar = '$id_keluar'"); //lihat qty saat ini
    ...
    if (isset($_POST['hapus'])) {
        ...
        $del = mysqli_query($conn, "DELETE FROM tb_buku_keluar WHERE id_keluar = '$id_keluar'");
                            ...
                            <form action="konfirmasi_data_keluar.php" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select" id="js-example-basic-single" name="id_buku" style="width: 100%;" aria-label="Default select example" name="id_buku" required>
                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            $sql = "SELECT 
                                        tbk.*, 
                                        DATE_FORMAT(tbk.tanggal, '%d-%m-%Y') AS tgl, 
                                        tb.judul_buku, 
                                        tb.kode_buku, 
                                        u.nama AS nama_user
                            ...
                            // Mengurutkan data berdasarkan judul buku dan membatasi data sesuai batasan yang telah ditentukan
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="mb-3 row">
                                                    <label for="jumlah" class="col-sm-2 col-form-label">Jumlah Keluar</label>
                                                    <div class="col-sm-10">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="" method="POST">
                                            <div class="modal-body">
                                                ...
                                                <p>Apakah Anda yakin ingin menghapus buku ini dari daftar transaksi data keluar?</p>
                                                <p>*Stock pada buku <?= $p['judul_buku'] ?> akan bertambah</p>
                                                <input type="hidden" name="id_keluar" value="<?=$id_keluar;?>">
                                                <input type="hidden" name="id_buku" value="<?=$id_buku;?>">
                                            </div>
                                            <div class="modal-footer">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination mb-0">
                            <?php
                                ...
                                $sql_jum = "SELECT * FROM `tb_buku_keluar` `tbk` INNER JOIN `tb_buku` `tb` ON `tbk`.`id_buku` = `tb`.`id_buku`";
                                if (!empty($katakunci)){
